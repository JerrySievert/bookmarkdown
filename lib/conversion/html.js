...
var chapter = fs.readFileSync(__dirname + '/../../templates/html/chapter.hb', 'utf8');
var toc = fs.readFileSync(__dirname + '/../../templates/html/toc.hb', 'utf8');
var index = fs.readFileSync(__dirname + '/../../templates/html/index.hb', 'utf8');
